...
public class HistoProductDTO {
	...
	Date fromDate;
	Date toDate;
	public HistoProductDTO(String productName, String code, Map<String, BigDecimal> mapValues, Date fromDate,
			Date toDate) {
	...
	public Map<String, BigDecimal> getMapValues() {
		return mapValues;
	}

	public void setMapValues(Map<String, BigDecimal> mapValues) {
		this.mapValues = mapValues;
	}
