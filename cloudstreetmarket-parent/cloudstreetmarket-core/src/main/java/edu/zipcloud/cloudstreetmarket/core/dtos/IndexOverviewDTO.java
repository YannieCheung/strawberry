...
public class IndexOverviewDTO implements Serializable{
	...
	public IndexOverviewDTO(String code, String name, String market, BigDecimal latestValue, BigDecimal latestChange,
			BigDecimal latestChangePercent, BigDecimal prevClose, BigDecimal high, BigDecimal low) {
		this.code = code;
		this.name = name;
		this.market = market;
